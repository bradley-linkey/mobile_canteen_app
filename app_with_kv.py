...
class MyScreenManager(ScreenManager):
    ...
    def add_to_island_snacks(self, button_name):
        ...
        self.ids.reciept_screen.ids.island_snacks_count.text = ' island snaks: ' + str(self.island_snacks_count) + ' = '+ str(self.island_snacks_product)
    ...
    def add_to_sun_flower_seeds(self, button_name):
        ...
        self.ids.reciept_screen.ids.sun_flower_seeds_count.text = ' sun flower seeds: ' + str(self.sun_flower_seeds_count) + ' = '+ str(self.sun_flower_seeds_product)
    ...
    def add_to_pop_tarts(self, button_name):
        ...
        self.ids.reciept_screen.ids.pop_tarts_count.text = ' pop tarts: ' + str(self.pop_tarts_count) + ' = '+ str(self.pop_tarts_product)
    ...
    def add_to_fruit_snacks(self, button_name):
        ...
        self.ids.reciept_screen.ids.fruit_snacks_count.text = ' fruit snacks: ' + str(self.fruit_snacks_count) + ' = '+ str(self.fruit_snacks_product)    
    
    def add_to_gum(self, button_name):
        self.gum_total += 1
        self.gum_count += 1
        self.gum_product = (self.gum_count * 2.5 )
    ...
    def add_to_gatorade_bar(self, button_name):
        ...
        self.ids.reciept_screen.ids.gatorade_bar_count.text = ' gatorade bar: ' + str(self.gatorade_bar_count) + ' = '+ str(self.gatorade_bar_product)
    ...
    def add_to_arizona(self, button_name):
        ...
        self.ids.reciept_screen.ids.arizona_count.text = ' azrizona: ' + str(self.arizona_count) + ' = '+ str(self.arizona_product)
    ...
    def add_to_body_armor(self, button_name):
        ...
        self.ids.reciept_screen.ids.body_armor_count.text = ' body armor: ' + str(self.body_armor_count) + ' = '+ str(self.body_armor_product)
    ...
    def add_to_star_bucks(self, button_name):
        ...
        self.ids.reciept_screen.ids.star_bucks_count.text = ' star bucks: ' + str(self.star_bucks_count) + ' = '+ str(self.star_bucks_product)
    ...
    def add_to_electro_life(self, button_name):
        ...
        self.ids.reciept_screen.ids.electro_life_count.text = ' electro life: ' + str(self.electro_life_count) + ' = '+ str(self.electro_life_product)
    ...
    def add_to_coconut_water(self, button_name):
        ...
        self.ids.reciept_screen.ids.coconut_water_count.text = ' coconut water: ' + str(self.coconut_water_count) + ' = '+ str(self.coconut_water_product)
    ...
    def add_to_breakfast(self, button_name):
        ...
        self.ids.reciept_screen.ids.breakfast_count.text = 'breakfast : ' + str(self.breakfast_count) + ' = '+ str(self.breakfast_product)  
    ...
    def add_to_small_burrito(self, button_name):
        ...
        self.ids.reciept_screen.ids.small_burrito_count.text = 'small burrito : ' + str(self.small_burrito_count) + ' = '+ str(self.small_burrito_product)  
    ...
    def add_to_large_burrito(self, button_name):
        ...
        self.ids.reciept_screen.ids.large_burrito_count.text = 'large burrito : ' + str(self.large_burrito_count) + ' = '+ str(self.large_burrito_product)  
    ...
    def add_to_fresh_and_ready(self, button_name):
        ...
        self.ids.reciept_screen.ids.fresh_and_ready_count.text = ' fresh and ready : ' + str(self.fresh_and_ready_count) + ' = '+ str(self.fresh_and_ready_product)  
